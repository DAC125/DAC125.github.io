    ...
    <section id="skills" className="section skills">
      ...
      <h1 className="subtitle">Frontend</h1>
        <div className="feSkills">
          ...
          <div className="col1">
            <h1>React</h1>
            <ProgressBar completed={90} bgColor="#004058" customLabel=" "/>
            <h1>Javascript</h1>
            <ProgressBar completed={90} bgColor="#004058" customLabel=" "/>
            <h1>Typescript</h1>
            <ProgressBar completed={90} bgColor="#004058" customLabel=" "/>
        ...
        <div className="beSkills">
          ...
          <div className="col1">
            <h1>Python</h1>
            <ProgressBar completed={95} bgColor="#004058" customLabel=" "/>
            <h1>Node.js</h1>
            <ProgressBar completed={90} bgColor="#004058" customLabel=" "/>
            <h1>Java</h1>
            <ProgressBar completed={70} bgColor="#004058" customLabel=" "/>
          </div>
          <div className="col2">
            <h1>C/C++</h1>
            <ProgressBar completed={70} bgColor="#004058" customLabel=" "/>
            ...
            <h1>NoSQL</h1>
            <ProgressBar completed={45} bgColor="#004058" customLabel=" "/>
          </div>
        </div>
        </div>
    </section>
